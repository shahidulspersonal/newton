...
<?php include 'nav.php'; ?>
    <div class="container mx-auto p-4 margin-auto">
        <h2 class="text-center mt-8">Our Glass Products</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4">
            ...
            $select = mysqli_query($conn, "SELECT name, details, image FROM product WHERE category = 'glass' ORDER BY name ASC") or die('query failed');
